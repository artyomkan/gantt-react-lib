...
import {hideChildrenTasks, mapTaskArrayToExtended, showChildrenTasks} from './utils';
...
export const Gantt: React.FunctionComponent<GanttProps> = ({
    ...
    const handleExpanderClick: TaskListProps["onExpanderClick"] = async (task, isExpanded) => {
        if (isExpanded) {
            const { tasks: newTasks, active: newActive } = hideChildrenTasks(task, tasks, active);
